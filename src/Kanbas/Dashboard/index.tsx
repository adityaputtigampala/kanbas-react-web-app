    ...
    return (
      <div id="wd-dashboard">
        ...
        <div id="wd-dashboard-courses">
          ...
          <div className="wd-dashboard-course">
            <img src="/images/cooking.jpg" width={200} />
            <div>
              <a className="wd-dashboard-course-link"
          ...
          <div className="wd-dashboard-course">
            <img src="/images/swimming.jpg" width={200} />
            <div>
              <a className="wd-dashboard-course-link"
          ...
          <div className="wd-dashboard-course">
            <img src="/images/biking.jpg" width={200} />
            <div>
              <a className="wd-dashboard-course-link"
          ...
          <div className="wd-dashboard-course">
            <img src="/images/pingpong.jpg" width={200} />
            <div>
              <a className="wd-dashboard-course-link"
          ...
          <div className="wd-dashboard-course">
            <img src="/images/gardening.jpg" width={200} />
            <div>
              <a className="wd-dashboard-course-link"
